...
public class EventResource {
    ...
    private List<EventResourceDefinition> resourceDefinitions = new ArrayList<EventResourceDefinition>();
    /**
    ...
    @JsonPropertyDescription("Declares this EventResource to be a valid implementation of a standardized or shared contract.\n\nAll implementations of the same implementation standard MAY be treated the same by a consumer.\nHowever, there MAY be differences in the access strategy, and compatible customizations by the implementer.\nThe implementation standard MAY define the role of the implementor (producer, consumer, both) and how it is determined.\n\nAs of now, only custom implementation standards are supported.")
    ...
    @JsonPropertyDescription("Declares this event resource is a compatible implementation of the referenced contract.\nThis is also sometimes known as [Service Provider Interface](https://en.wikipedia.org/wiki/Service_provider_interface).\n\nMUST be a valid reference to an (usually external) [Event Resource](#event-resource) ORD ID.\n\nAll event resources that share the same `compatibleWith` value MAY be treated the same or similar by a consumer client.")
     ...
     * 
     */
    @JsonProperty("eventResourceLinks")
    @JsonPropertyDescription("Links with semantic meaning that are specific to event resources.\n\nIf applicable, `eventResourceLinks` MUST be used instead of generic `links`.")
    private List<APIEventResourceLink> eventResourceLinks = new ArrayList<APIEventResourceLink>();
    /**
     ...
     *     
     *     The date format MUST comply with [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6).
     * @param customImplementationStandard
     *     If the fixed `implementationStandard` values need to be extended, an arbitrary `customImplementationStandard` can be provided.
     *     
     *     MUST be a valid [Specification ID](../index.md#specification-id).
     *     
     ...
     *     
     *     `lineOfBusiness` that are assigned to a `Package` are inherited to all of the ORD resources it contains.
     * @param exposedEntityTypes
     *     Optional list of [entity types](#entity-type) that are exposed by the resource.
     *     
     *     This replaces `entityTypeMappings`. If both is given, the `exposedEntityTypes` wins.
     *     
     *     MUST be a valid reference to an [EntityType](#entity-type) ORD ID.
     * @param defaultConsumptionBundle
     *     References the default consumption bundle to use for this resource.
     *     
     *     MUST be a valid reference to a [Consumption Bundle](#consumption-bundle) ORD ID.
     *     
     ...
     *     
     *     Every resource MUST be part of one package.
     * @param customImplementationStandardDescription
     *     Full description of the custom implementation standard, notated in [CommonMark](https://spec.commonmark.org/) (Markdown).
     *     
     *     MUST only be provided if `implementationStandard` is set to `custom`.
     *     
     ...
     *     
     *     As of now, only custom implementation standards are supported.
     * @param partOfConsumptionBundles
     *     List of references to the consumption bundles in this resource belongs to.
     *     
     *     MUST be a valid reference to a [Consumption Bundle](#consumption-bundle) ORD ID.
     *     
     ...
     *     Together with `systemInstanceAware`, this property SHOULD be used to optimize the metadata crawling process of the ORD aggregators.
     */
    public EventResource(String ordId, String localId, List<String> correlationIds, String title, String shortDescription, String description, String partOfPackage, List<String> partOfGroups, List<ConsumptionBundleReference> partOfConsumptionBundles, String defaultConsumptionBundle, List<String> partOfProducts, String version, Date lastUpdate, String visibility, String releaseStatus, Boolean disabled, String minSystemVersion, Date deprecationDate, Date sunsetDate, List<String> successors, List<ChangelogEntry> changelogEntries, List<EventResourceDefinition> resourceDefinitions, String implementationStandard, String customImplementationStandard, String customImplementationStandardDescription, List<String> compatibleWith, String responsible, List<EntityTypeMapping> entityTypeMappings, List<ExposedEntityType> exposedEntityTypes, List<APIEventResourceLink> eventResourceLinks, List<Link> links, Extensible extensible, List<String> countries, List<String> lineOfBusiness, List<String> industry, List<String> tags, Labels labels, DocumentationLabels documentationLabels, String policyLevel, String customPolicyLevel, List<String> policyLevels, Boolean systemInstanceAware) {
        super();
        this.ordId = ordId;
        ...
        this.eventResourceLinks = eventResourceLinks;
        this.links = links;
    ...
    public EventResource withOrdId(String ordId) {
        this.ordId = ordId;
        return this;
    }
    ...
    public EventResource withLocalId(String localId) {
        this.localId = localId;
        return this;
    }
    ...
    public EventResource withCorrelationIds(List<String> correlationIds) {
        this.correlationIds = correlationIds;
        return this;
    }
    ...
    public EventResource withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public EventResource withShortDescription(String shortDescription) {
        this.shortDescription = shortDescription;
        return this;
    }
    ...
    public EventResource withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public EventResource withPartOfPackage(String partOfPackage) {
        this.partOfPackage = partOfPackage;
        return this;
    }
    ...
    public EventResource withPartOfGroups(List<String> partOfGroups) {
        this.partOfGroups = partOfGroups;
        return this;
    }
    ...
    public EventResource withPartOfConsumptionBundles(List<ConsumptionBundleReference> partOfConsumptionBundles) {
        this.partOfConsumptionBundles = partOfConsumptionBundles;
        return this;
    }
    ...
    public EventResource withDefaultConsumptionBundle(String defaultConsumptionBundle) {
        this.defaultConsumptionBundle = defaultConsumptionBundle;
        return this;
    }
    ...
    public EventResource withPartOfProducts(List<String> partOfProducts) {
        this.partOfProducts = partOfProducts;
        return this;
    }
    ...
    public EventResource withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public EventResource withLastUpdate(Date lastUpdate) {
        this.lastUpdate = lastUpdate;
        return this;
    }
    ...
    public EventResource withVisibility(String visibility) {
        this.visibility = visibility;
        return this;
    }
    ...
    public EventResource withReleaseStatus(String releaseStatus) {
        this.releaseStatus = releaseStatus;
        return this;
    }
    ...
    public EventResource withDisabled(Boolean disabled) {
        this.disabled = disabled;
        return this;
    }
    ...
    public EventResource withMinSystemVersion(String minSystemVersion) {
        this.minSystemVersion = minSystemVersion;
        return this;
    }
    ...
    public EventResource withDeprecationDate(Date deprecationDate) {
        this.deprecationDate = deprecationDate;
        return this;
    }
    ...
    public EventResource withSunsetDate(Date sunsetDate) {
        this.sunsetDate = sunsetDate;
        return this;
    }
    ...
    public EventResource withSuccessors(List<String> successors) {
        this.successors = successors;
        return this;
    }
    ...
    public EventResource withChangelogEntries(List<ChangelogEntry> changelogEntries) {
        this.changelogEntries = changelogEntries;
        return this;
    }
     ...
     */
    @JsonProperty("resourceDefinitions")
    public List<EventResourceDefinition> getResourceDefinitions() {
     ...
     */
    @JsonProperty("resourceDefinitions")
    public void setResourceDefinitions(List<EventResourceDefinition> resourceDefinitions) {
        this.resourceDefinitions = resourceDefinitions;
    }

    public EventResource withResourceDefinitions(List<EventResourceDefinition> resourceDefinitions) {
        this.resourceDefinitions = resourceDefinitions;
        return this;
    }
    ...
    public EventResource withImplementationStandard(String implementationStandard) {
        this.implementationStandard = implementationStandard;
        return this;
    }
    ...
    public EventResource withCustomImplementationStandard(String customImplementationStandard) {
        this.customImplementationStandard = customImplementationStandard;
        return this;
    }
    ...
    public EventResource withCustomImplementationStandardDescription(String customImplementationStandardDescription) {
        this.customImplementationStandardDescription = customImplementationStandardDescription;
        return this;
    }
    ...
    public EventResource withCompatibleWith(List<String> compatibleWith) {
        this.compatibleWith = compatibleWith;
        return this;
    }
    ...
    public EventResource withResponsible(String responsible) {
        this.responsible = responsible;
        return this;
    }
    ...
    public EventResource withEntityTypeMappings(List<EntityTypeMapping> entityTypeMappings) {
        this.entityTypeMappings = entityTypeMappings;
        return this;
    }
    ...
    public EventResource withExposedEntityTypes(List<ExposedEntityType> exposedEntityTypes) {
        this.exposedEntityTypes = exposedEntityTypes;
        return this;
    }
     ...
     */
    @JsonProperty("eventResourceLinks")
    public List<APIEventResourceLink> getEventResourceLinks() {
     ...
     */
    @JsonProperty("eventResourceLinks")
    public void setEventResourceLinks(List<APIEventResourceLink> eventResourceLinks) {
        this.eventResourceLinks = eventResourceLinks;
    }

    public EventResource withEventResourceLinks(List<APIEventResourceLink> eventResourceLinks) {
        this.eventResourceLinks = eventResourceLinks;
        return this;
    }
    ...
    public EventResource withLinks(List<Link> links) {
        this.links = links;
        return this;
    }
    ...
    public EventResource withExtensible(Extensible extensible) {
        this.extensible = extensible;
        return this;
    }
    ...
    public EventResource withCountries(List<String> countries) {
        this.countries = countries;
        return this;
    }
    ...
    public EventResource withLineOfBusiness(List<String> lineOfBusiness) {
        this.lineOfBusiness = lineOfBusiness;
        return this;
    }
    ...
    public EventResource withIndustry(List<String> industry) {
        this.industry = industry;
        return this;
    }
    ...
    public EventResource withTags(List<String> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public EventResource withLabels(Labels labels) {
        this.labels = labels;
        return this;
    }
    ...
    public EventResource withDocumentationLabels(DocumentationLabels documentationLabels) {
        this.documentationLabels = documentationLabels;
        return this;
    }
    ...
    public EventResource withPolicyLevel(String policyLevel) {
        this.policyLevel = policyLevel;
        return this;
    }
    ...
    public EventResource withCustomPolicyLevel(String customPolicyLevel) {
        this.customPolicyLevel = customPolicyLevel;
        return this;
    }
    ...
    public EventResource withPolicyLevels(List<String> policyLevels) {
        this.policyLevels = policyLevels;
        return this;
    }
    ...
    public EventResource withSystemInstanceAware(Boolean systemInstanceAware) {
        this.systemInstanceAware = systemInstanceAware;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EventResource.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ordId");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("eventResourceLinks");
        sb.append('=');
        sb.append(((this.eventResourceLinks == null)?"<null>":this.eventResourceLinks));
        sb.append(',');
        sb.append("links");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.eventResourceLinks == null)? 0 :this.eventResourceLinks.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EventResource) == false) {
            return false;
        }

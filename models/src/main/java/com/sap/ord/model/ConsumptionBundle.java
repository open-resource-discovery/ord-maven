...
public class ConsumptionBundle implements com.sap.ord.service.hooks.PartialOrdPojo {
     ...
     * @param visibility
     *     The visibility states who is allowed to "see" the described resource or capability.
     * @param credentialExchangeStrategies
     *     Defines the supported strategies for how the consumption credentials can be exchanged.
     *     
     *     Ideally, the system type supports a strategy that can automate the exchange.
     ...
     *     Tags that are assigned to a `Package` are inherited to all of the ORD resources it contains.
     */
    public ConsumptionBundle(String ordId, String localId, List<String> correlationIds, String title, String shortDescription, String description, String version, Date lastUpdate, String visibility, List<CredentialExchangeStrategy> credentialExchangeStrategies, List<Link> links, List<String> tags, Labels labels, DocumentationLabels documentationLabels) {
        super();
        this.ordId = ordId;

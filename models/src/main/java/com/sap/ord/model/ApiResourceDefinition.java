...
public class ApiResourceDefinition implements com.sap.ord.service.hooks.PartialOrdPojo {
     ...
     *     It is RECOMMENDED to provide a relative URL (to base URL).
     */
    public ApiResourceDefinition(String type, String customType, String mediaType, String url, List<AccessStrategy> accessStrategies) {
        super();
        this.type = type;

...
public class ApiResource implements com.sap.ord.service.hooks.PartialOrdPojo {
     ...
     *     The value MUST be an existing option in the corresponding `partOfConsumptionBundles` array.
     * @param usage
     *     Usage. Define from where the API resource can be used and accessed.
     ...
     *     
     *     Together with `systemInstanceAware`, this property SHOULD be used to optimize the metadata crawling process of the ORD aggregators.
     * @param apiResourceLinks
     *     Links with semantic meaning that are specific to API Resources.
     */
    public ApiResource(String ordId, String localId, List<String> correlationIds, String title, String shortDescription, String description, String partOfPackage, List<String> partOfGroups, List<ConsumptionBundleReference> partOfConsumptionBundles, String defaultConsumptionBundle, List<String> partOfProducts, String version, Date lastUpdate, String visibility, String releaseStatus, Boolean disabled, String minSystemVersion, Date deprecationDate, Date sunsetDate, List<String> successors, List<ChangelogEntry> changelogEntries, List<String> entryPoints, String direction, String apiProtocol, List<ApiResourceDefinition> resourceDefinitions, String implementationStandard, String customImplementationStandard, String customImplementationStandardDescription, List<String> compatibleWith, String responsible, List<String> supportedUseCases, String usage, List<EntityTypeMapping> entityTypeMappings, List<ExposedEntityType> exposedEntityTypes, List<APIEventResourceLink> apiResourceLinks, List<Link> links, Extensible extensible, List<String> countries, List<String> lineOfBusiness, List<String> industry, List<String> tags, Labels labels, DocumentationLabels documentationLabels, String policyLevel, String customPolicyLevel, List<String> policyLevels, Boolean systemInstanceAware) {
        super();
        this.ordId = ordId;

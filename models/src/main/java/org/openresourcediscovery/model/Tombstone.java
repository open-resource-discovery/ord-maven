...
@JsonPropertyOrder({"ordId", "groupId", "groupTypeId", "removalDate", "description"})
public class Tombstone {
  ...
  public String toString() {
    ...
    sb.append(Tombstone.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((((this.groupTypeId == rhs.groupTypeId)
                ...
                && ((this.removalDate == rhs.removalDate)
                    || ((this.removalDate != null) && this.removalDate.equals(rhs.removalDate))))

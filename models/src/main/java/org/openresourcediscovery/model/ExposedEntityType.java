...
public class ExposedEntityType implements org.openresourcediscovery.service.hooks.PartialOrdPojo {
    ...
    public ExposedEntityType withOrdId(String ordId) {
        this.ordId = ordId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ExposedEntityType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ordId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExposedEntityType) == false) {
            return false;
        }
        ExposedEntityType rhs = ((ExposedEntityType) other);

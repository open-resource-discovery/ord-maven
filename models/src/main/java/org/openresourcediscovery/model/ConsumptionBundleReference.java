...
@JsonPropertyOrder({"ordId", "defaultEntryPoint"})
...
public class ConsumptionBundleReference {
  ...
  public String toString() {
    ...
    sb.append(ConsumptionBundleReference.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((this.ordId == rhs.ordId) || ((this.ordId != null) && this.ordId.equals(rhs.ordId)))
        && ((this.defaultEntryPoint == rhs.defaultEntryPoint)
            || ((this.defaultEntryPoint != null) && this.defaultEntryPoint.equals(rhs.defaultEntryPoint))));
  }
}

...
@JsonPropertyOrder({"systemNamespace", "correlationIds", "labels", "documentationLabels", "tags"})
...
public class SystemType {
  ...
  public String toString() {
    ...
    sb.append(SystemType.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.systemNamespace == rhs.systemNamespace)
                        || ((this.systemNamespace != null)
                            && this.systemNamespace.equals(rhs.systemNamespace)))

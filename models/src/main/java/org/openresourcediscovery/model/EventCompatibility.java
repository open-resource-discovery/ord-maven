...
@JsonPropertyOrder({"ordId", "maxVersion"})
...
public class EventCompatibility {
  ...
  public String toString() {
    ...
    sb.append(EventCompatibility.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((this.ordId == rhs.ordId) || ((this.ordId != null) && this.ordId.equals(rhs.ordId)))
        && ((this.maxVersion == rhs.maxVersion)
            || ((this.maxVersion != null) && this.maxVersion.equals(rhs.maxVersion))));
  }
}

...
public class CredentialExchangeStrategy {
  ...
  public String toString() {
    ...
    sb.append(CredentialExchangeStrategy.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((this.customType == rhs.customType)
                ...
                && ((this.callbackUrl == rhs.callbackUrl)
                    || ((this.callbackUrl != null) && this.callbackUrl.equals(rhs.callbackUrl))))
            && ((this.type == rhs.type) || ((this.type != null) && this.type.equals(rhs.type))))
        && ((this.customDescription == rhs.customDescription)
            || ((this.customDescription != null) && this.customDescription.equals(rhs.customDescription))));
  }
}

...
@JsonPropertyOrder({"apiModelSelectors", "entityTypeTargets"})
...
public class EntityTypeMapping {
  ...
  public String toString() {
    ...
    sb.append(EntityTypeMapping.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((this.entityTypeTargets == rhs.entityTypeTargets)
            || ((this.entityTypeTargets != null) && this.entityTypeTargets.equals(rhs.entityTypeTargets)))
        && ((this.apiModelSelectors == rhs.apiModelSelectors)
            || ((this.apiModelSelectors != null) && this.apiModelSelectors.equals(rhs.apiModelSelectors))));
  }
}

...
public class RelatedApiResource {
    ...
    public RelatedApiResource withOrdId(String ordId) {
        this.ordId = ordId;
        return this;
    }
    ...
    public RelatedApiResource withRelationType(String relationType) {
        this.relationType = relationType;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RelatedApiResource.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ordId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedApiResource) == false) {
            return false;
        }
        RelatedApiResource rhs = ((RelatedApiResource) other);

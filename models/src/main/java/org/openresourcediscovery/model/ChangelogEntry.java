...
@JsonPropertyOrder({"version", "releaseStatus", "date", "description", "url"})
...
public class ChangelogEntry {
  ...
  public String toString() {
    ...
    sb.append(ChangelogEntry.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.releaseStatus == rhs.releaseStatus)
                        || ((this.releaseStatus != null)
                            && this.releaseStatus.equals(rhs.releaseStatus)))
                    && ((this.date == rhs.date)
                        || ((this.date != null) && this.date.equals(rhs.date))))

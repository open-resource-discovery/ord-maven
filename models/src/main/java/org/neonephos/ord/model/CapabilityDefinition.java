...
public class CapabilityDefinition implements org.neonephos.ord.service.hooks.PartialOrdPojo {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("Type of the capability resource definition")
    private String type;
    /**
    ...
    public CapabilityDefinition withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public CapabilityDefinition withCustomType(String customType) {
        this.customType = customType;
        return this;
    }
    ...
    public CapabilityDefinition withMediaType(String mediaType) {
        this.mediaType = mediaType;
        return this;
    }
    ...
    public CapabilityDefinition withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public CapabilityDefinition withAccessStrategies(List<AccessStrategy> accessStrategies) {
        this.accessStrategies = accessStrategies;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CapabilityDefinition.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CapabilityDefinition) == false) {
            return false;
        }
